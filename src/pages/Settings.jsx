...
const Settings = () => {
  ...
  const handleAddTenant = () => {
    ...
    addTenant(newTenantName.trim(), newTenantLogo.trim());
        ...
        <div className="rounded-2xl border border-mist-200 bg-white p-6 shadow-card">
          ...
          <div className="mb-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <input
              ...
              className="rounded-lg border border-mist-200 px-3 py-2 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
            />
            <input
              value={newTenantLogo}
          ...
          <button
            ...
            className="mb-3 flex items-center gap-1.5 rounded-lg bg-brand-600 px-3 py-2 text-xs font-semibold text-white hover:bg-brand-700"
          >
            ...
            {tenants.map((t) => (
              ...
              >
                <div className="flex items-center gap-2">
                  {t.logo && (
                    <img src={t.logo} alt={t.name} className="h-6 w-6 rounded object-contain" />
                  )}
